...
jQuery(function($){
	...
	$.FroalaEditor.RegisterCommand('linkMore', {
		  ...
		  callback: function (cmd, val) {
			  ...
			  qfy_popinfo_fun("<div class='dialog_contents' style='box-shadow:0 0 3px rgba(0, 0, 0, .15);border-top:5px solid #222;padding:20px;background:#fff;width:600px;height:440px;'><iframe src='"+src+"'  style='width:600px;height:400px;border: 0;' /><div style='    text-align: right;'><input type='button' class=' btn_insert_link' value='应用' >&nbsp;&nbsp;<input type='button' class='btn_close_link' value='关闭' ></div></div>");
			  $(".qfy_popinfo").css("z-index","13389").width("600");
			  $(".fr-popup.fr-active").removeClass("fr-active"); 
			  jQuery(".qfy_popinfo .btn_insert_link").unbind().bind("click",function(e){
				  if($el.find('.fr-image-resizer.fr-active').length==0){
						img.click();
						link.imageLink();
					}
					var iconFrame = jQuery('.dialog_contents iframe')[0].contentWindow;
			   ...
			   jQuery(".qfy_popinfo .btn_close_link").unbind().bind("click",function(){
				   jQuery(".qfy_popinfo").remove();
				   if($el.find('.fr-image-resizer.fr-active').length==0){
						img.click();
						link.imageLink();
	...
	$.FroalaEditor.RegisterCommand('insertLink2', {
		  ...
		  callback: function () {
			  ...
			  if($this.selection.text()!="" ||  link  ){
				  ...
				  qfy_popinfo_fun("<div class='dialog_contents' style='box-shadow:0 0 3px rgba(0, 0, 0, .15);border-top:5px solid #222;padding:20px;background:#fff;width:600px;height:440px;'><iframe src='"+src+"'  style='width:600px;height:400px;border: 0;' /><div style='    text-align: right;'><input type='button' class=' btn_insert_link' value='应用' >&nbsp;&nbsp;<input type='button' class='btn_close_link' value='关闭' ></div></div>");
				  $(".qfy_popinfo").css("z-index","13389").width("600");
				  jQuery(".qfy_popinfo .btn_insert_link").unbind().bind("click",function(){
					   var iconFrame = jQuery('.dialog_contents iframe')[0].contentWindow;
						var obj=iconFrame.jQuery('#result a');
						var url=obj.attr("href");
				  ...
				  qfy_popinfo_fun("<div style='padding:20px;'>请先选择一段区域来添加链接！</div>",2);
			  }
	...
	$.FroalaEditor.RegisterCommand('insertBtn', {
		  ...
		  callback: function () {
				 ...
				 var src = '/FeiEditor/bitSite/wp/bottstarpButton.php';
				  ...
				  $(".qfy_popinfo").css("z-index","13389").width("880");
				  jQuery(".qfy_popinfo .btn_insert_link").unbind().bind("click",function(){
					    var iFrame = jQuery('.dialog_contents iframe')[0].contentWindow;
